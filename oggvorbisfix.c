...
char* OggS = "OggS\x00\x02\x00\x00\x00\x00\x00\x00\x00\x00";
char* Zeroes = "\x00\x00\x00\x00";
char* HeaderEnd = "\x01\x1E\x01vorbis\x00\x00\x00\x00\x02\x44\xAC\x00\x00\x00\x00\x00\x00";
...
int main(int argc, char *argv[])
{
    ...
    for (count = 1; count < argc; count++)
    {
        ...
        // Write header (includes start of file bit)
        ...
        fwrite(HeaderEnd, 22, 1, ogg_file);
        fclose(ogg_file);
    }
    return 0;
}
